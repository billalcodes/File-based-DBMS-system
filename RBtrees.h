...
void find(int starting,int searchedkey, int upperlimit) {   //Searching for record in given files
    int fl = 0;
...
void maketree(string rootfilename) {
    ...
    temp_root4 = read(rootfilename, name[3], obj4);
    rootfile << temp_root4->data.key << "," << r1lf << "," << r1ll << "\n";

    temp_root5 = read(rootfilename, name[4], obj5);
    rootfile << temp_root5->data.key << "," << r1lf << "," << r1ll << "\n";

    temp_root6 = read(rootfilename, name[5], obj6);
    rootfile << temp_root6->data.key << "," << r1lf << "," << r1ll << "\n";

    temp_root7 = read(rootfilename, name[6], obj7);
    rootfile << temp_root7->data.key << "," << r1lf << "," << r1ll << "\n";

    temp_root8 = read(rootfilename, name[7], obj8);
    rootfile << temp_root8->data.key << "," << r1lf << "," << r1ll << "\n";

    temp_root9 = read(rootfilename, name[8], obj9);
    rootfile << temp_root9->data.key << "," << r1lf << "," << r1ll << "\n";

    temp_root10 = read(rootfilename, name[9], obj10);
    rootfile << temp_root10->data.key << "," << r1lf << "," << r1ll << "\n";
    rootfile.close();
}
void update(string rootfilename,int starting, int searchedkey, int upperlimit) {   //updating record in given files
    int fl = 0;
...
void remove(string rootfilename, int starting,int searchedkey, int upperlimit) {   //Deleting record in given files
    int fl = 0;
    ...
    if (Rbtreeoperation == 1) {
        ...
        while (!readroot.eof()) {
            ...
            if (temp_id <= stoi(row[0])) {
                find(stoi(row[1]),temp_id, stoi(row[2]));
                break;
            }
        }
    }
        ...
        while (!readroot.eof()) {
            ...
            if (temp_id <= stoi(row[0])) {
                update(rootfilename,stoi(row[1]), temp_id, stoi(row[2]));
                break;
            }
        }
    }
        ...
        while (!readroot.eof()) {
            ...
            if (temp_id <= stoi(row[0])) {
                remove(rootfilename,stoi(row[1]), temp_id, stoi(row[2]));
                break;
            }
        }
    }
